<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <li class="nav-item active">
        <a class="nav-link" href="{{ route('admin.view.home') }}">
    ...
    <!-- Nav Item - Tables -->
    <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseTwo-table"
           aria-expanded="true" aria-controls="collapseTwo">
            <i class="fas fa-fw fa-cog"></i>
            <span>Table</span>
        </a>
        <div id="collapseTwo-table" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <h6 class="collapse-header">List table</h6>
                <a class="collapse-item" href="{{ route('admin.view.table-users') }}">Table user</a>
                <a class="collapse-item" href="{{ route('admin.view.table-orders') }}">Table order</a>
            </div>
        </div>
    </li>
    @endcan
